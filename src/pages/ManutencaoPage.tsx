...
import { Monitor, Cpu, HardDrive, Wrench } from 'lucide-react';
    ...
    <div className="overflow-x-hidden"> {/* Adicionado overflow-x-hidden */}
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"> {/* Ajuste para grid responsivo */}
